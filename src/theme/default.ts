export default {
  button: {
    ...
    color: {
      ...
      link:
        'text-blue-500 bg-none border-transparent hover:text-blue-600 hover:bg-none focus:text-blue-600 focus:bg-none active:text-blue-600 active:bg-none',
      primary:
  ...
  form: {
    base:
      'border border-solid transition-colors duration-500 active:border-blue-500 outline-none outline-offset-0 focus:outline-none focus:border-blue-500 leading-tight',
